...
const Socket: React.FC = () => {
    ...
    return (
        <nav id="sidebar">
            <ul>
                <li className="logo">
                    <svg version="1.1" viewBox="0 0 2048 595" width="83" height="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    ...
                    <ul className="sub-menu">
                        <div>
                            <li><a>View Existing Groups</a></li>
                ...
                <li>
                    ...
                    <ul className="sub-menu">
                        <div>
                            <li><a>View Existing Campaigns</a></li>
                            <li><a>Create New Campaign</a></li>
                        </div>
                    </ul>
                </li>
                <li>
                    ...
                    <ul className="sub-menu">
                        <div>
                            <li><a>View Advertisements</a></li>
                            <li><a>Create Advertisement</a></li>
                        </div>
                    </ul>
                </li>
                <li>
                <button onClick={(event) => toggleSubmenu(event.currentTarget)} className="dropdown-btn">
                    ...
                    <ul className="sub-menu">
                        <div>
                            <li><a>View Existing Users</a></li>
                            <li><a>Add/Modify User</a></li>
                        </div>
                    </ul>
                </li>
                <li>
